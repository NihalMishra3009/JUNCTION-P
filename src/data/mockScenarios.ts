...
export const SCENARIOS: Record<ScenarioId, ScenarioDefinition> = {
  NORMAL: {
    ...
    pressure: {
      ...
      WANKHEDE_EXIT: p(61,78,88,90), ROAD_MARINE_DR: p(54,69,79,83),
  ...
  POST_EVENT_SURGE: {
    ...
    pressure: {
      ...
      WANKHEDE_EXIT: p(88,93,85,69), ROAD_MARINE_DR: p(82,87,79,64),
  ...
  TRANSPORT_DISRUPTION: {
    ...
    pressure: {
      ...
      WANKHEDE_EXIT: p(72,83,91,94), ROAD_MARINE_DR: p(74,83,89,91),
  ...
  HEAVY_RAIN: {
    ...
    pressure: {
      ...
      WANKHEDE_EXIT: p(75,83,89,92), ROAD_MARINE_DR: p(71,79,86,88),
  ...
  EVENT_DELAY: {
    ...
    pressure: {
      ...
      WANKHEDE_EXIT: p(42,59,74,85), ROAD_MARINE_DR: p(41,55,67,78),
