// ============================================================
// JUNCTION - Human-in-the-Loop Recommendation Rejection Endpoint
// ============================================================
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: `Intervention '${id}' rejected by ${actorId}.`,
      intervention: updatedIntervention,
      auditRecord,
    });
  } catch (error: any) {
    return NextResponse.json(
      { success: false, error: error.message || "Failed to reject intervention" },
      { status: 500 }
    );
  }
}
