...
export const OPERATIONAL_ZONES: ZoneDefinition[] = [
  {
    ...
    subZoneIds: ["ZONE_WANKHEDE_GATE_1", "ZONE_WANKHEDE_GATE_2"],
    hotelIds: [],
  ...
  {
    id: "ZONE_WANKHEDE_GATE_1",
    name: "Wankhede Stadium — Exit Gate 1",
    shortName: "Exit Gate 1",
    tier: "TIER_1_CRITICAL",
    defaultMonitoringStatus: "CONTINUOUS",
    parentZoneId: "ZONE_WANKHEDE",
    center: { latitude: 18.9385, longitude: 72.8252 },
    radiusMeters: 140,
    resourceIds: ["WANKHEDE_EXIT_GATE_1"],
    hotelIds: [],
    connectedRoadIds: ["ROAD_MARINE_DR"],
    nominalPedestrianCapacity: 10000,
    nominalTransitCapacity: 0,
    description: "North perimeter turnstiles and primary egress chute toward Marine Drive.",
  },
  {
    id: "ZONE_WANKHEDE_GATE_2",
    name: "Wankhede Stadium — Exit Gate 2",
    shortName: "Exit Gate 2",
    tier: "TIER_1_CRITICAL",
    defaultMonitoringStatus: "CONTINUOUS",
    parentZoneId: "ZONE_WANKHEDE",
    center: { latitude: 18.9375, longitude: 72.8262 },
    radiusMeters: 140,
    resourceIds: ["WANKHEDE_EXIT_GATE_2"],
    hotelIds: [],
    connectedRoadIds: ["ROAD_VEER_NARIMAN"],
    nominalPedestrianCapacity: 8000,
    nominalTransitCapacity: 0,
    description: "South perimeter turnstiles and egress chute toward Churchgate & Taxi Staging.",
  },
  {
    id: "ZONE_CHURCHGATE",
...
export const ZONE_COVERAGE_PROFILES: Record<string, ZoneCoverageProfile> = {
  ...
  ZONE_WANKHEDE_GATE_1: {
    zoneId: "ZONE_WANKHEDE_GATE_1",
    displayName: "Wankhede Stadium — Exit Gate 1",
    coverageStatus: "FULL",
    dataSource: "SENSOR_FUSED",
    registeredDeviceCount: 3,
    deviceModalities: ["TURNSTILE_GATE", "CCTV_CAMERA"],
    ...
    freshnessMaxAgeSeconds: 30,
    canTriggerOperationalRecommendations: true,
    assumptions: "North exit turnstiles and CCTV-01 concourse coverage.",
  },
  ZONE_WANKHEDE_GATE_2: {
    zoneId: "ZONE_WANKHEDE_GATE_2",
    displayName: "Wankhede Stadium — Exit Gate 2",
    coverageStatus: "FULL",
    dataSource: "SENSOR_FUSED",
    registeredDeviceCount: 3,
    deviceModalities: ["TURNSTILE_GATE", "CCTV_CAMERA"],
    ...
    freshnessMaxAgeSeconds: 30,
    canTriggerOperationalRecommendations: true,
    assumptions: "South exit turnstiles and CCTV-02 perimeter coverage.",
  },
  ZONE_MAHAPALIKA: {
